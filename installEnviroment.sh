...
function configAll(){
	if [[ $EUID -ne 0 ]]; then
		...
		mkdir /home/$1/.config/bspwm && cp -r ./configs/bspwm/* ~/.config/bspwm
		mkdir /home/$1/.config/sxhkd && cp -r ./configs/sxhkd/* ~/.config/sxhkd
		mkdir /home/$1/.config/picom && cp -r ./configs/picom/* ~/.config/picom
		mkdir /home/$1/.config/polybar && cp -r ./configs/polybar/* ~/.config/picom
		mkdir /home/$1/.config/kitty && cp -r ./configs/kitty/* ~/.config/kitty
